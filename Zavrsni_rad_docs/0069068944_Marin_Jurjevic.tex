...
% upisati vrstu rada
\documenttype{Završni rad}  % Zavrsni rad ili Diplomski 

\title{Implementacija algoritma za detekciju sudara}   % upisati specificni naslov rada
...
\lstlistoflistings
\listofalgorithms
\addcontentsline{toc}{chapter}{Popis pseudokodova}
